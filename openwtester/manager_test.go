...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WH7EDdXdozqjmKwDdziWqrFMBW61pPR7Xz")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WH7EDdXdozqjmKwDdziWqrFMBW61pPR7Xz"
	account := &openwallet.AssetsAccount{Alias: "mainnetBSV", WalletID: walletID, Required: 1, Symbol: "BSV", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WH7EDdXdozqjmKwDdziWqrFMBW61pPR7Xz"
	accountID := "HvMc4jzPE8ea84aaMnT8uxJW4faXwJ2pKE2v1p3u9j5H"
